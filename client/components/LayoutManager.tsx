    ...
    const applyGrid = (mode: string) => {
        ...
        containers.forEach(el => {
            ...
            if (mode === 'row') {
                ...
                el.style.setProperty('grid-template-columns', 'repeat(auto-fill, minmax(280px, 1fr))', 'important');
                el.style.setProperty('gap', '0.75rem', 'important');
            }
        });
        ...
        if (gen) {
            if (mode === 'row') {
                ...
                gen.style.setProperty('grid-template-columns', 'repeat(auto-fill, minmax(280px, 1fr))', 'important');
            }
        }
    };
